...
/**
  ...
  *
  * @checksum - 48456ce2fa337cbe9180eedd9256cd2cb5f129e6455e559b61d5346f1541cc06
  * @variables - radius=rounded,accentColor=blue,colorTemperature=gray,spacing=2,scale=base,inputShadow=shadow,baseColorShade=500,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
